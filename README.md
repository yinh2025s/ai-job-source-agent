...
- Current fixed live benchmark: 51/51 official websites, 51/51 career/job-list pages, 50/51 exact openings, and 51/51 expectation checks in 58.5 seconds with four workers. Greenhouse, Ashby, Lever, Workday, SmartRecruiters, Workable, Rippling, BambooHR, iCIMS, and SuccessFactors each have five fixed live companies.
...
- July 13 focused replay after that cluster: Plaid parent-card extraction and Snowflake Phenom structured state both reached exact openings (2/2); Uber and Snowflake reached corrected Oracle/Phenom list roots. The remaining six opening misses stay open rather than being counted as solved.
