...
- 20 个主要 provider 已使用原生 adapter，包括 Rippling、Google Careers、page-aware Phenom、Paycom、RippleHire、Taleo、Eightfold、JazzHR、Avature、Breezy 和 Meta Careers；Meta 仅提供 visible-page positive evidence，generic fallback 仍是 compatibility path，CEIPAL 因公开接口 bot block 暂无 adapter。
