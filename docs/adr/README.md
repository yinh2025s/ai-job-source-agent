...
ADR 用于记录会长期影响模块边界、兼容性或运行模型的决定。

状态使用：`proposed`、`accepted`、`deprecated`、`superseded`。
...
- [ADR-0031: Capture User-Mediated External Apply Targets](0031-capture-user-mediated-external-apply-targets.md)
