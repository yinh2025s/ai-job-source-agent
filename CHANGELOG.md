...
- CI/runtime 闭环接入 GitHub Actions：supported matrix 覆盖 3.10、3.11、3.12、3.13，release-offline job 固定 3.12 执行 Makefile contract；手动 live workflow 使用 20 分钟 job timeout、禁止并发取消，并在成功或失败时保留 14 天证据 artifacts。
